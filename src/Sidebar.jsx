...
function Sidebar({chain, connections}) {
    return (
        <div className="min-h-screen flex flex-col flex-auto flex-shrink-0 antialiased bg-zinc-200 text-gray-800">
            <div className="fixed flex flex-col top-0 left-0 w-56 bg-white h-full border-r">
                <div className="flex bg-black items-center justify-center h-14 border-b border-zinc-600">
                </div>
                <div className="overflow-y-auto overflow-x-hidden flex-grow bg-zinc-900">
                    <ul className="flex flex-col py-4 space-y-1">
                        <li><Link to="/overview">
                            <span href="#" className="relative flex flex-row items-center h-11 focus:outline-none hover:bg-zinc-100 text-gray-500 hover:text-gray-800 border-l-4 border-transparent hover:border-yellow-500 pr-6">
                        ...
                        <li><Link to="/chain">
                            <span href="#" className="relative flex flex-row items-center h-11 focus:outline-none hover:bg-zinc-200 text-gray-500 hover:text-gray-800 border-l-4 border-transparent hover:border-yellow-500 pr-6">
                                <span className="inline-flex justify-center items-center ml-4">
                        ...
                        <li><Link to="/defi2">
                            <span href="#" className="relative flex flex-row items-center h-11 focus:outline-none hover:bg-zinc-200 text-gray-500 hover:text-gray-800 border-l-4 border-transparent hover:border-yellow-500 pr-6">
                                ...
                                <span className=" px-2 py-0.5 ml-auto text-xs font-medium tracking-wide text-yellow-600 ">Not Soon</span>
                            </span>
                        </Link></li>
                        <li><Link to="/health">
                            <span href="#" className="relative flex flex-row items-center h-11 focus:outline-none hover:bg-zinc-200 text-gray-500 hover:text-gray-800 border-l-4 border-transparent hover:border-yellow-500 pr-6">
